                ...
                <div class="container mt-5">
                    <div class="card">
                        ...
                        <div class=" col-12 col-sm-4">
                            <a href="<?= base_url('kisah/tambah') ?>" class="btn btn-outline-primary float-right">+ Tambah Kisah</a>
                        </div>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="<?= base_url('kisah/edit/' . $data['id']) ?>"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                        <a class="dropdown-item" href="<?= base_url('kisah/delete/' . $data['id']) ?>"><i class="bx bx-trash me-1"></i> Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
